<section id="login" class="container-custom">
	...
	<div class="container container-content">
		<div class="row dark-grey row-custom">
			<?php
			if (!isset($_SESSION['sess_user_active']) || $_SESSION['sess_user_active'] == false) {
				...
				<div class="col-md-10 col-md-offset-2">
					...
					<p>
						<a class="page-scroll btn btn-warning" href="index.php?link=profile" role="button">Edytuj profil &raquo;</a>
						 lub 
						<a class="page-scroll btn btn-danger" href="index.php?link=logout" role="button">Wyloguj &raquo;</a>
					</p>
				</div>
				<?php
			}
